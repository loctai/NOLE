            ...
            if check_f1_left_right['f1_left'] == True and check_f1_left_right['f1_right'] == True:
                ...
                if float(percent) > 0:
                    ...
                    if float(amount_receve) > 0:
                        commission_50 = float(amount_receve)/2
    ...
    if customer_ml['p_node'] != 0:
        ...
        if int(percent)> 0:
            ...
            if float(commission) > 0:
                ...
                balance_usd = round(float(customer_ml_p_node['wallet']['usd_balance']) + float(commission), 2)
